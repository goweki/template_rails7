...
module ActionController::Base::HelperMethods
  ...
  # source://actionpack/7.0.8.4/lib/action_controller/metal/flash.rb#39
  def alert(*args, **_arg1, &block); end

  # source://actionpack/7.0.8.4/lib/abstract_controller/caching/fragments.rb#31
  def combined_fragment_cache_key(*args, **_arg1, &block); end

  # source://actionpack/7.0.8.4/lib/action_controller/metal/content_security_policy.rb#11
  def content_security_policy?(*args, **_arg1, &block); end

  # source://actionpack/7.0.8.4/lib/action_controller/metal/content_security_policy.rb#12
  def content_security_policy_nonce(*args, **_arg1, &block); end

  # source://actionpack/7.0.8.4/lib/action_controller/metal/cookies.rb#8
  ...
  # source://actionpack/7.0.8.4/lib/action_controller/metal/request_forgery_protection.rb#106
  def form_authenticity_token(*args, **_arg1, &block); end

  # source://actionpack/7.0.8.4/lib/action_controller/metal/flash.rb#39
  def notice(*args, **_arg1, &block); end

  # source://actionpack/7.0.8.4/lib/action_controller/metal/request_forgery_protection.rb#107
  def protect_against_forgery?(*args, **_arg1, &block); end

  # source://devise/4.9.4/lib/devise/controllers/helpers.rb#13
  def signed_in?(*args, **_arg1, &block); end

  def turbo_frame_request?(*args, **_arg1, &block); end
  def turbo_frame_request_id(*args, **_arg1, &block); end
  def turbo_native_app?(*args, **_arg1, &block); end

  # source://actionpack/7.0.8.4/lib/abstract_controller/caching.rb#43
...
module Turbo
  ...
  # source://activesupport/7.0.8.4/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#56
  def current_request_id; end

  # source://activesupport/7.0.8.4/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#100
  ...
  class << self
    # source://activesupport/7.0.8.4/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#48
    def current_request_id; end

    # source://activesupport/7.0.8.4/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#92
    def current_request_id=(obj); end
